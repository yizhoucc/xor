...
def main():
    ...
    for si, seed in enumerate(seeds):
        ...
        for ep in range(10):
            ...
            save_ckpt(swiglu, os.path.basename(args.save_dir), 'swiglu_phase1', seed, ep+1)
        ...
        for ep in range(10):
            ...
            save_ckpt(swiglu, os.path.basename(args.save_dir), 'swiglu_phase2', seed, ep+1)
        ...
        for ep in range(10):
            ...
            save_ckpt(innernet_model, os.path.basename(args.save_dir), 'innernet_phase2', seed, ep+1)
        ...
        for ep in range(50):
            ...
            save_ckpt(frozen_model, os.path.basename(args.save_dir), 'frozen_innernet', seed, ep+1)
            if ppl < best_frozen:
                best_frozen = ppl
                no_improve = 0
            else:
