...
def test():
  key = ["split_train", "split_val", "loss", "hidden_dim", "num_prop", "aggregate_type", "lr", "wd"]
  # val = [['MSE', 'KL-pq', 'KL-qp'], [64, 128], [5, 10], ['att', 'avg', 'sum'], [0.001], [0]]
  # val = [['MSE', 'KL-pq'], [64], [10], ['avg', 'sum'], [0.001], [0]]
  # val = [['KL-pq'], [32, 64], [5,7,9,11,13,15,17], ['sum'], [0.001], [0]]
  val = [['train_11', 'train_12', 'train_13', 'train_14', 'train_15', 'train_16', 'train_17', 'train_18', 'train_19', 'train_20', 'train_21', 'train_22'],
         ['val_11', 'val_12', 'val_13', 'val_14', 'val_15', 'val_16', 'val_17', 'val_18', 'val_19', 'val_20', 'val_21', 'val_21'], ['KL-pq'], [32], [15], ['sum'], [0.001], [0]]
  bind_key = [["split_train", "split_val"]]
  ...
  for ii in range(num_trial):
    ...
    with open("config/node_gnn.yaml", 'r') as ymlfile:
      cfg = yaml.load(ymlfile, Loader=yaml.FullLoader)

      for jj, kk in enumerate(key):
        cfg['dataset'][kk] = val_list[jj]
        # if jj < 4:
        #   cfg['model'][kk] = val_list[jj]
        # else:
        #   cfg['train'][kk] = val_list[jj]

    with open("config/node_gnn_{:03d}.yaml".format(1+ii), 'w') as ymlfile:
