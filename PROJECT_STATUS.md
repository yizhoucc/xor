...
| m4 | 计算开销分析（FLOPs + wall-clock） | ⏳ Cluster jobs 677696/677697已提交 | 677696在CPU分区重生成原论文对照图；677697将在同一GPU、同一进程中测CNN/Transformer的参数量、主要算子FLOPs、推理/训练吞吐和峰值显存。完成通知677698。 |
